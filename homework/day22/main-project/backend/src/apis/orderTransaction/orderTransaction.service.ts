...
import { OrderTransaction, ORDER_TRANSACTION_STATUS_ENUM } from "./entities/orderTransaction.entity";
...
export class OrderTransactionService {
  ...
  async create({ impUid, amount, currentUser, roomId, checkInDate, checkOutDate}){
    ...
    // orderTransaction 생성
    const orderTransaction = await this.orderTransactionRepository.save(orderTransaction_)
